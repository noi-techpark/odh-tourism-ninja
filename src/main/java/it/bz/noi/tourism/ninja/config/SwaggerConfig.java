...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("it.bz.noi.tourism.ninja"))
				.build()
				.apiInfo(apiInfo());
	}
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				"Tourism API NINJA REST API",
				"This page contains the documentation about the API REST calls of the Tourism API, the core component of the ODH Project.\n"
